...
namespace CourseWork_KovalVadim_IS01
{
    class LuxRoom : Room
    {
        ...
        public LuxRoom(int area, int roomNumber, int placesNumber, bool coffeeMachine, bool wifi, bool pets, MealType type, bool minibar, bool condition)
        {
            Area = area;
        ...
        public override void Rent(Guest[] guestsArr, int toDay, int toMonth, int toYear)
        {
            ...
            RentedOn(new RoomEventArgs("Thank you! You successfully rented a room. Type: lux. Room number: " + this.RoomNumber, this.RoomNumber));
        }
        ...
        public override void Book(Guest[] guestsArr, int fromDay, int toDay, int fromMonth, int toMonth, int fromYear, int toYear)
        {
            ...
            BookedOn(new RoomEventArgs("Thank you! You successfully booked a room. Type: lux. Room number: " + this.RoomNumber, this.RoomNumber));
        }

        public override void PayFor(ref int sum, Guest[] guestsArr, DateTime fromDate, DateTime toDate)
        {
            sum += 1000 * guestsArr.Length * toDate.Subtract(fromDate).Days;
        ...
        {
            int nowSum = 1000 * guestsArr.Length * toDate.Subtract(fromDate).Days;
            if (Coffemachine == true)
            {
